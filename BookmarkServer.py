...
def CheckURI(uri, timeout=5):
    '''Check whether this URI is reachable, i.e does it retunr a 200 OK?

    This function return True if a GET request to uri returns a 200 OK, and
...
class Shortener(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        # Decode the forma data.
        lenght = int(self.headers.get('Content-length', 0))
        body = self.rfile.read(lenght).decode()
